...
import br.com.kesyodev.gestao_vagas.modules.company.useCases.CreateJobUseCase;
...
public class JobController {
    ...
    @Operation(summary = "Cadastro de vagas", description = "Essa função é resposável por cadastrar as vagas dentro da empresa.")
    @ApiResponses({
